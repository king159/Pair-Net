...
class CrossHeadBaseline(AnchorFreeHead):
    def __init__(
        self,
        num_classes,
        in_channels,
    ...
    def get_bboxes(self, cls_scores, mask_preds, img_metas, rescale=False):
        ...
        for img_id in range(len(img_metas)):
            ...
            # sub_pos = cls_scores["sub_pos"][img_id, ...]
            # obj_pos = cls_scores["obj_pos"][img_id, ...]
    ...
    def _get_bboxes_single(
        ...
        # sub_pos = sub_pos.squeeze()
        # sub_pos = sub_pos[triplet_index]
        # obj_pos = obj_pos.squeeze()
        # obj_pos = obj_pos[triplet_index]
