...
class MotifHead(RelationHead):
    def __init__(self, **kwargs):
        ...
        self.context_layer = LSTMContext(
        ...
        self.rel_compress = nn.Linear(
            self.context_pooling_dim, self.num_predicates, bias=True
        )
    ...
    def forward(
        ...
        if self.with_relation_ranker:
            det_result = self.relation_ranking_forward(
                prod_rep, det_result, gt_result, num_rels, is_testing
            )
